...
#  $(aws ecr get-login --no-include-email --region ap-northeast-1 --profile share) && docker image pull 199750128665.dkr.ecr.ap-northeast-1.amazonaws.com/chat:v11
# docker run -p 80:80  -it 199750128665.dkr.ecr.ap-northeast-1.amazonaws.com/chat:v1
